        ...
        <div class="container mt-3">
            ...
            <div class="row">
                ...
                <div class="col" id="dataBox">
                    <table class="table">
                        <thead>
                             <tr> <td>id</td> <td>title</td> <td>content</td> <td>thumbnail</td> <td>userId</td> <td>username</td> <td>createdAt</td> <td></td> </tr>
                        </thead>
                        <tbody>
                        <c:forEach items="${datas}" var="data">
                            <tr id="data-${data.id}"> <td>${data.id}</td> <td>${data.title}</td> <td>${data.content}</td> 
                            <td>${data.thumbnail}</td> <td>${data.userId}</td> <td>${data.username}</td> <td>${data.createdAt}</td> 
